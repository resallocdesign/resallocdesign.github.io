          ...
          {choices.map((value, index: number) => {
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className={`bg-gray-100 hover:shadow-lg hover:bg-gray-200 rounded-lg w-full py-2 px-4 ${
                        "" !== otherOption
                          ? "bg-purple-300 hover:bg-purple-300 font-bold tracking-wider"
                          : ""
                      }`}
                    />
                  </div>
            ...
            return (
              <button
                ...
                className={`bg-purple-100 hover:shadow-lg hover:bg-purple-200 font-bold rounded-lg  tracking-wider py-2 ${selectedItems[index] ? "bg-purple-300 hover:bg-purple-300" : "" }`}>
                {value}
              </button>
            );
          })}
